...
require_once('PHPMailer/class.phpmailer.php');
		  ...
		  Agora você está inscrito na nossa newsletter. Aguarde novidades! <br /><br />
		  ".$site_name."
  		  </td>
  		  </tr>
  		";
  		...
  		$email_body = "
  		  ...
  		  <td  style='padding:5px;' align='center' colspan='2'>
  		  <font size='4'>
  		  <b>Novo inscrito na Newsletter</b>
  		  </font>
  		  </td>
  		  </tr>
  		";
...
if($mail->Send()) {
  ...
  $mail->ClearAddresses();
  $mail->Subject       = utf8_decode("Assinatura de Newsletter");
  $mail->MsgHTML($body_retorno);
  $mail->AddAddress($_POST['email'], $_POST['nome']);
  $mail->Send();
  $mail->ClearAddresses();	  
  
	$_SESSION["msg_to_display"] = "Inscrição confirmada!";
	$_SESSION["success"] = 1;
  		  
  echo '
  <script type="text/javascript">
	alert(\''.utf8_decode('').'Inscrição realizada com sucesso!\');window.location=\''.$_SERVER["HTTP_REFERER"].'\';
  </script>
  ';
  exit();
} else {
